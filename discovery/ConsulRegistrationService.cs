...
public sealed class ConsulRegistrationService : IHostedService
{
    ...
    public Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        {
            _logger.LogWarning("Discovery:Service:Name and :Port are not both set — this process will not register");
    ...
    private string ResolveAdvertisedAddress()
    {
        ...
        _logger.LogWarning(
            "Discovery:Service:UseIpAddress is set but no non-loopback IPv4 address was found; advertising the hostname instead");
        return Dns.GetHostName();
    }
